...
Read [embedding and ownership guidance](docs/usage.md), the [docs hub](docs/README.md)
(ADRs + feature map), [coding standards](coding_standards.md), and
...
the mandatory mechanical gate. Feature maps live in `docs/features/`; requirement
evidence in `docs/verification/`; historical specialist notes in
...
Milestone narratives (including loop 3) are under
[`docs/archive/milestones/`](docs/archive/milestones/). Release qualification
status is tracked in the [requirements ledger](docs/verification/requirements.md).
