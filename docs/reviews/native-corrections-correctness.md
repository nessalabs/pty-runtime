...
`crates/infrastructure/src/terminal/`. `docs/reviews/terminal-page-capacity-admission.md`
and `docs/reviews/terminal-continuation-c1-introducer.md` were treated as
...
1. `docs/reviews/terminal-continuation-c1-introducer.md` states that "`state.rs`
...
- P2 — `docs/reviews/terminal-continuation-c1-introducer.md` misstates the
