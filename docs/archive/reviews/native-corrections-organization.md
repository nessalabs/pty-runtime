...
`docs/archive/reviews/terminal-*.md` diagnosis, and the seventh (the bitmap allocator
capacity defect) is documented instead in `docs/archive/reviews/bitmap-capacity-independent.md`
...
experiments only, and indexes neither `docs/archive/reviews/` (108 files) nor
...
2. **P2 — cited evidence file is empty.**
   ...
   `docs/archive/reviews/terminal-continuation-c1-introducer.md:96` cites "the unfiltered
...
| "each defect has its own `docs/archive/reviews/terminal-*.md` diagnosis" | Six of seven. The allocator defect is documented in `bitmap-capacity-*.md`, which `README.md:99-106` omits. |
...
| `docs/archive/reviews/terminal-page-capacity-admission.md` | 88 | `ce71f347a99d7f3895873369d74aec30b17047dccab56b94e8493208868c1a88` |
| `docs/archive/reviews/terminal-continuation-c1-introducer.md` | 94 | `4d0db1c940e50ed55367717c11d9845bace30e958b763297d827eedbd7bb976b` |
