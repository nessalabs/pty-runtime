...
PATCH_SHA256 = "84b1b7a84db7342a95a9cff941f2cb866f2370859c83daa25a8d106e06acc91d"
...
def verify(source, prepare=False, built=False):
    ...
    if prepare and needs_patch:
        # Stage original files so a previously applied cursor-only patch
        # or growth-only patch and a fresh archive use the same operation.
